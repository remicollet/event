--TEST--
Check for EventBufferEvent when exception is thrown from the write callback
--SKIPIF--
<?php
...
$writer->setCallbacks(null, function () {
...
Warning: EventBase::loop(): Breaking the loop due to exception RuntimeException in %s/33-bevent-write-cb-exception.php on line %d
